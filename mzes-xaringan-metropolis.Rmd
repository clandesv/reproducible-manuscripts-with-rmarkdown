...
* **Access**: Open access is given when research is freely available to everyone without financial, legal, or technical barriers barriers ([UNESCO 2022](https://en.unesco.org/open-access/what-open-access)), for example commercial software. E.g.,
